<template><div><h1 id="k8s-iam-项目官方以及学习指南" tabindex="-1"><a class="header-anchor" href="#k8s-iam-项目官方以及学习指南" aria-hidden="true">#</a> K8s-iam 项目官方以及学习指南</h1>
<div class="custom-container tip"><p class="custom-container-title">🎯 IAM 教程</p>
<ul>
<li><a href="./iam">iam 教程</a></li>
</ul>
</div>
...
<p><a href="https://github.com/cubxxw/awesome-cs-cloudnative-blockchain" target="_blank" rel="noopener noreferrer"> 🖱️github地址<ExternalLinkIcon/></a></p>
