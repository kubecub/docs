...
<h1 id="第37节-基于kubernetes的云原生架构设计" tabindex="-1"><a class="header-anchor" href="#第37节-基于kubernetes的云原生架构设计" aria-hidden="true">#</a> 第37节 基于Kubernetes的云原生架构设计</h1>
<br>
...
<hr>
<nav class="table-of-contents"><ul><li><router-link to="#云原生简介">云原生简介</router-link><ul><li><router-link to="#cncf-云原生计算基金会-简介">CNCF（云原生计算基金会）简介</router-link></li><li><router-link to="#什么是云原生">什么是云原生？</router-link></li><li><router-link to="#什么是云原生应用">什么是云原生应用？</router-link></li></ul></li><li><router-link to="#云原生架构包含很多内容-如何学习">云原生架构包含很多内容，如何学习？</router-link></li><li><router-link to="#系统资源层的云原生架构设计">系统资源层的云原生架构设计</router-link><ul><li><router-link to="#kubernetes集群高可用方案设计">Kubernetes集群高可用方案设计</router-link></li><li><router-link to="#kubernetes应用的高可用">Kubernetes应用的高可用</router-link></li></ul></li><li><router-link to="#应用层的云原生架构设计">应用层的云原生架构设计</router-link><ul><li><router-link to="#微服务实现">微服务实现</router-link></li><li><router-link to="#微服务架构设计">微服务架构设计</router-link></li><li><router-link to="#微服务高可用架构设计">微服务高可用架构设计</router-link></li></ul></li><li><router-link to="#云原生架构鸟瞰图">云原生架构鸟瞰图</router-link></li><li><router-link to="#公有云版云原生架构">公有云版云原生架构</router-link></li><li><router-link to="#总结">总结</router-link></li><li><router-link to="#课后练习">课后练习</router-link></li><li><router-link to="#end-链接">END 链接</router-link></li></ul></nav>
<p>[TOC]</p>
<p>前面两讲，我们一起看了云技术的演进之路。软件架构已经进入了云原生时代，云原生架构是当下最流行的软件部署架构。那么这一讲，我就和你聊聊什么是云原生，以及如何设计一种基于Kubernetes的云原生部署架构。</p>
<h2 id="云原生简介" tabindex="-1"><a class="header-anchor" href="#云原生简介" aria-hidden="true">#</a> 云原生简介</h2>
...
<h3 id="cncf-云原生计算基金会-简介" tabindex="-1"><a class="header-anchor" href="#cncf-云原生计算基金会-简介" aria-hidden="true">#</a> CNCF（云原生计算基金会）简介</h3>
<p><a href="https://www.cncf.io/" target="_blank" rel="noopener noreferrer">CNCF<ExternalLinkIcon/></a>（Cloud Native Computing Foundation，云原生计算基金会），2015年由谷歌牵头成立，目前已有一百多个企业与机构作为成员，包括亚马逊、微软、思科、红帽等巨头。CNCF致力于培育和维护一个厂商中立的开源社区生态，用以推广云原生技术。</p>
<p>CNCF目前托管了非常多的开源项目，其中有很多我们耳熟能详的项目，例如 Kubernetes、Prometheus、Envoy、Istio、etcd等。更多的项目，你可以参考CNCF公布的<a href="https://landscape.cncf.io/images/landscape.png" target="_blank" rel="noopener noreferrer">Cloud Native Landscape<ExternalLinkIcon/></a>，它给出了云原生生态的参考体系，如下图所示：</p>
<p><img src="http://sm.nsddd.top/sm202303062154204.jpeg" alt="img"></p>
<h3 id="什么是云原生" tabindex="-1"><a class="header-anchor" href="#什么是云原生" aria-hidden="true">#</a> 什么是云原生？</h3>
...
<p><img src="http://sm.nsddd.top/sm202303062154943.jpeg" alt="img"></p>
...
<p>在 <a href="https://time.geekbang.org/column/article/414159" target="_blank" rel="noopener noreferrer">43讲<ExternalLinkIcon/></a> 和 <a href="https://time.geekbang.org/column/article/414856" target="_blank" rel="noopener noreferrer">44讲<ExternalLinkIcon/></a> 中，我介绍了容器、服务网格和微服务，这里再补充介绍下不可变基础设施和声明式API。</p>
...
<p>Kubernetes的API设计，就是一种典型的声明式API。例如，我们在创建Deployment时，在Kubernetes YAML文件中声明应用的副本数为<code v-pre>2</code>，即设置<code v-pre>replicas: 2</code>，Deployment Controller就会确保应用的副本数一直为<code v-pre>2</code>。也就是说，如果当前副本数大于<code v-pre>2</code>，Deployment Controller会删除多余的副本；如果当前副本数小于<code v-pre>2</code>，会创建新的副本。</p>
<p>声明式设计是一种设计理念，同时也是一种工作模式，它使得你的系统更加健壮。分布式系统环境可能会出现各种不确定的故障，面对这些组件故障，如果使用声明式 API ，你只需要查看对应组件的 API 服务器状态，再确定需要执行的操作即可。</p>
<h3 id="什么是云原生应用" tabindex="-1"><a class="header-anchor" href="#什么是云原生应用" aria-hidden="true">#</a> 什么是云原生应用？</h3>
...
<h2 id="云原生架构包含很多内容-如何学习" tabindex="-1"><a class="header-anchor" href="#云原生架构包含很多内容-如何学习" aria-hidden="true">#</a> 云原生架构包含很多内容，如何学习？</h2>
...
<h2 id="系统资源层的云原生架构设计" tabindex="-1"><a class="header-anchor" href="#系统资源层的云原生架构设计" aria-hidden="true">#</a> 系统资源层的云原生架构设计</h2>
<p>先来看系统资源层面的云原生架构设计。对于一个系统来说，系统资源的架构是需要优先考虑的。在云原生架构中，当前的业界标准是通过Docker提供系统资源（例如CPU、内存等），通过Kubernetes来编排Docker容器。Docker和Kubernetes的架构，我在<a href="https://time.geekbang.org/column/article/414159" target="_blank" rel="noopener noreferrer">43讲<ExternalLinkIcon/></a>中介绍过，这里我主要介绍下系统资源层面的高可用架构设计。</p>
...
<p>我们来分别看下这两个高可用方案。</p>
<h3 id="kubernetes集群高可用方案设计" tabindex="-1"><a class="header-anchor" href="#kubernetes集群高可用方案设计" aria-hidden="true">#</a> Kubernetes集群高可用方案设计</h3>
<p>通过<a href="https://time.geekbang.org/column/article/414159" target="_blank" rel="noopener noreferrer">43讲<ExternalLinkIcon/></a>的学习，我们知道Kubernetes由kube-apiserver、kube-controller-manager、kube-scheduler、cloud-controller-manager、etcd、kubelet、kube-proxy、container runtime 8大核心组件组成。</p>
...
<p><img src="http://sm.nsddd.top/sm202303062155421.jpeg" alt="img"></p>
<p>上面图片展示的方案中，所有管理节点都部署了 <code v-pre>kube-apiserver</code>、<code v-pre>kube-controller-manager</code>、<code v-pre>kube-scheduler</code>、etcd等组件。<code v-pre>kube-apiserver</code> 均与本地的etcd进行通信，etcd在三个节点间同步数据；而 <code v-pre>kube-controller-manager</code>、<code v-pre>kube-scheduler</code>和 <code v-pre>cloud-controller-manager</code>，也只与本地的kube-apiserver进行通信，或者通过负载均衡访问。</p>
...
<h3 id="kubernetes应用的高可用" tabindex="-1"><a class="header-anchor" href="#kubernetes应用的高可用" aria-hidden="true">#</a> Kubernetes应用的高可用</h3>
...
<p>高可用原理如下图所示：</p>
<p><img src="http://sm.nsddd.top/sm202303062157231.jpeg" alt="img"></p>
<p>在Kubernetes中，我们可以给每个Pod打上标签（Label），标签是一个key-value对，例如<code v-pre>label: app=Nginx</code>。当我们访问Service时，Service会根据它配置的Label Selector，匹配具有相同Label的Pod，并将这些Pod的endpoint地址作为其后端RS。</p>
<p>举个例子，你可以看看上面的图片：Service的Label Selector是Labels<code v-pre>app=Nginx</code>，这样就会选择我们创建的具有<code v-pre>label: app=Nginx</code>的3个Pod实例。这时候，Service会根据其负载均衡策略，选取一个Pod将请求流量转发过去。当其中一个Pod故障时，Kubernetes会自动将故障Pod的endpoint从Service后端对应的RS列表中剔除。</p>
<p>由Deployment创建的ReplicaSet，这时候也会发现有一个Pod故障，健康的Pod实例数变为<code v-pre>2</code>，这时候跟其期望的值<code v-pre>3</code>不匹配，就会自动创建一个新的健康Pod，替换掉故障的Pod。因为新Pod满足Service的Label Selector，所以新Pod的endpoint会被Kubernetes自动添加到Service对应的endpoint列表中。</p>
...
<h2 id="应用层的云原生架构设计" tabindex="-1"><a class="header-anchor" href="#应用层的云原生架构设计" aria-hidden="true">#</a> 应用层的云原生架构设计</h2>
...
<h3 id="微服务实现" tabindex="-1"><a class="header-anchor" href="#微服务实现" aria-hidden="true">#</a> 微服务实现</h3>
<p>我们可以通过两种方式来构建微服务：</p>
<ul>
<li>采用Gin、Echo等轻量级Web框架。</li>
<li>采用微服务框架，例如 <a href="https://github.com/go-chassis/go-chassis" target="_blank" rel="noopener noreferrer">go-chassis<ExternalLinkIcon/></a>、<a href="https://github.com/asim/go-micro" target="_blank" rel="noopener noreferrer">go-micro<ExternalLinkIcon/></a>、<a href="https://github.com/go-kit/kit" target="_blank" rel="noopener noreferrer">go-kit<ExternalLinkIcon/></a>等。</li>
</ul>
...
<p><a href="https://static001.geekbang.org/resource/image/7a/65/7a860825662bb93f93c51c00efbdeb65.jpg?wh=2248x1158" target="_blank" rel="noopener noreferrer"><img src="https://static001.geekbang.org/resource/image/7a/65/7a860825662bb93f93c51c00efbdeb65.jpg?wh=2248x1158" alt="img"><ExternalLinkIcon/></a></p>
...
<h3 id="微服务架构设计" tabindex="-1"><a class="header-anchor" href="#微服务架构设计" aria-hidden="true">#</a> 微服务架构设计</h3>
<p>上面我介绍了如何实现微服务，这里我再来具体讲讲，上面提到的各个组件/功能是如何有机组合在一起，共同构建一个微服务应用的。下面是微服务的架构图：</p>
<p><a href="https://static001.geekbang.org/resource/image/02/yy/020fa7eccc352d03b78b57a1dbfc75yy.jpg?wh=2248x2168" target="_blank" rel="noopener noreferrer"><img src="https://static001.geekbang.org/resource/image/02/yy/020fa7eccc352d03b78b57a1dbfc75yy.jpg?wh=2248x2168" alt="img"><ExternalLinkIcon/></a></p>
...
<p>微服务在启动时会将自己的endpoint信息（通常是<code v-pre>ip:port</code>格式）上报到服务中心。微服务也会定时上报自己的心跳到服务中心。在服务中心中，我们可以监控微服务的状态，剔除不健康的微服务，获取微服务之间的访问数据，等等。如果要通过网关调用微服务，或者需要使用网关做负载均衡，那我们还需要网关从服务中心中获取微服务的endpoint信息。</p>
<h3 id="微服务高可用架构设计" tabindex="-1"><a class="header-anchor" href="#微服务高可用架构设计" aria-hidden="true">#</a> 微服务高可用架构设计</h3>
...
<h2 id="云原生架构鸟瞰图" tabindex="-1"><a class="header-anchor" href="#云原生架构鸟瞰图" aria-hidden="true">#</a> 云原生架构鸟瞰图</h2>
<p>上面，我介绍了系统资源层和应用层的云原生架构设计，但还不能构成整个云原生架构设计。这里，我通过一张云原生架构鸟瞰图，来整体介绍下云原生架构的设计方案。</p>
<p><a href="https://static001.geekbang.org/resource/image/05/b5/05c7cb8fd6c524242229ab9ea6c9b1b5.jpg?wh=2248x1470" target="_blank" rel="noopener noreferrer"><img src="https://static001.geekbang.org/resource/image/05/b5/05c7cb8fd6c524242229ab9ea6c9b1b5.jpg?wh=2248x1470" alt="img"><ExternalLinkIcon/></a></p>
...
<h2 id="公有云版云原生架构" tabindex="-1"><a class="header-anchor" href="#公有云版云原生架构" aria-hidden="true">#</a> 公有云版云原生架构</h2>
...
<p><a href="https://static001.geekbang.org/resource/image/44/20/4473c11e51fa0976d91202fc7c836020.jpg?wh=2249x1068" target="_blank" rel="noopener noreferrer"><img src="https://static001.geekbang.org/resource/image/44/20/4473c11e51fa0976d91202fc7c836020.jpg?wh=2249x1068" alt="img"><ExternalLinkIcon/></a></p>
...
<p>在系统资源层，腾讯云提供了多种计算资源提供形态。例如：通过TKE，可以创建原生的Kubernetes集群；通过EKS，可以创建Serverless化的Kubernetes集群；通过<a href="https://github.com/superedge/superedge" target="_blank" rel="noopener noreferrer">TKE-Edge<ExternalLinkIcon/></a>，可以创建能够纳管边缘节点的Kubernetes集群。此外，还提供了开源容器服务平台<a href="https://github.com/tkestack/tke" target="_blank" rel="noopener noreferrer">TKEStack<ExternalLinkIcon/></a>，TKEStack是一个非常优秀的容器云平台，在代码质量、稳定性、平台功能等方面，都在开源的容器云平台中处于龙头地位，也欢迎你Star。</p>
